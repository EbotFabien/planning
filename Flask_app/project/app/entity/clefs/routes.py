...
def modify(ide):
        ...
        if status == 'Realise':
            ...
            request.json["numero_sol_propriete"]=rdv.json()[0]["propriete"]["numeroSol"]
            request.json["intervention"]=rdv.json()[0]["intervention"]["id"]
            request.json["client"]=rdv.json()[0]["client"]["id"]
            request.json["date"]=rdv.json()[0]["date"]
            request.json["statut"]= 0
            request.json["passeur"]=rdv.json()[0]["passeur"]["id"]
            request.json["agent"]= rdv.json()[0]["agent"]["id"]
            request.json["type_propriete"]= 1
